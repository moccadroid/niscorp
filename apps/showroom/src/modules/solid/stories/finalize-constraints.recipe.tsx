...
type Props = { mode?: ValidationMode; constraints?: ConstraintsMode };

export const Demo: FC<Props> = ({ mode = 'recover', constraints = 'finalize' }) => {
  ...
  const start = (): void => {
    ...
    const stream = createStream({ schema, initial, mode, constraints });
    stream.on(setValue);

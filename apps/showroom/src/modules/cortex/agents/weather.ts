// ═══════════════════════════════════════════════════════════
// Weather agent + tool — Cortex tool-use demo
// ═══════════════════════════════════════════════════════════
//
// A trivial agent + a fake weather tool. Demonstrates Cortex's
// tool loop end-to-end:
//   - the agent looks at the user prompt and decides which tool
//     calls to make (one per city the user mentioned)
//   - Cortex's tool loop validates each tool call's input against
//     the tool's Zod schema
//   - tool results become observations the agent sees in the
//     next loop iteration
//   - the agent finalizes a structured report once it has all
//     the data it needs
//
// The data is hardcoded so the demo is reproducible.

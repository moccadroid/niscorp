...
// and their behaviour — is the `modal` ActionFragment (data, not code),
// dropped in here as `children`. A backdrop click fires `ui:click ref="close"`,
// which the fragment's close trigger pops; that dismiss is the only behaviour
// the backdrop owns.

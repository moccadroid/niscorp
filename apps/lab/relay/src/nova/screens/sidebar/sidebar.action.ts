...
export const sidebarAction: ActionDefinition = {
  ...
  triggers: [
    ...
    { event: 'ui:click', ref: 'nav-pipeline', do: [{ replace: { action: 'deals-board', canvas: 'main' } }, { emit: { channel: 'nav' } }, { emit: { channel: 'screen-pipeline' } }] },
    ...
    { event: 'ui:click', ref: 'nav-deals', do: [{ replace: { action: 'deals', canvas: 'main' } }, { emit: { channel: 'nav' } }, { emit: { channel: 'screen-deals' } }] },

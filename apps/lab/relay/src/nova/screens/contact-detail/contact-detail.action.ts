  ...
  triggers: [
      ...
      do: [
        {
          push: {
            ...
            canvas: 'modal',
            with: ['modal'],
            input: { id: '$.view.record.contact_id', name: '$.view.record.name', email: '$.view.record.email', phone: '$.view.record.phone', title: '$.view.record.title', company: '$.view.record.company.company_id' },
          },
        },
      ],
    },
    ...
    { event: 'ui:click', ref: 'open-deal', do: [{ push: { action: 'deal-modal', canvas: 'modal', input: { id: '@event.payload' } } }] },
    {
      ...
      do: [
        ...
        { replace: { action: 'company-detail', canvas: 'detail', input: { id: '@event.payload' } } },
      ],
    },
  ],
};

...
| [lyra-stripe.md](lyra-stripe.md) | **Partially built** | Payments as an integration. The integration and the trust story ship; invoicing, receipts and tax do not. Part 6 lists what a human must supply. |
